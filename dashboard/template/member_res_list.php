...
$sql = "select a.*, b.exhbt_nm, b.exhbt_type_cd from user_exhbt_info as a, exhbt_info as b where a.exhbt_cd = b.exhbt_cd";
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th>User Email <label class="mdi mdi-sort"></label></th>
                                        <th style="text-align:center">Platform <label class="mdi mdi-sort"></label></th>
                                        <th style="text-align:center">전시번호 <label class="mdi mdi-sort"></label></th>
                                        <th>전시 명 <label class="mdi mdi-sort"></label></th>
                                        <th style="text-align:center">카테고리(1depth) <label class="mdi mdi-sort"></label></th>
                                        <th style="text-align:center">상태 <label class="mdi mdi-sort"></label></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?
                                    for ($i = 0; $row = mysqli_fetch_array($result); $i++) {
                                        ...
                                        if ($row['comp_cd'] == 1) {
                                            $comp_cd = '<td class="text-warning" style="text-align:center">카카오</td>';
                                        } elseif ($row['comp_cd'] == 2) {
                                            $comp_cd = '<td class="text-success" style="text-align:center">구글</td>';
                                        } elseif ($row['comp_cd'] == 3) {
                                            $comp_cd = '<td class="text-danger" style="text-align:center"> 애플 </td>';
                                        } else {
                                            $comp_cd = '오류';
                                        }

                                        if ($row['state_cd'] == 10) {
                                            $state_cd = '<td style="text-align:center" class ="text-warning"><b>찜</b>';
                                        } elseif ($row['state_cd'] == 20) {
                                            $state_cd = '<td style="text-align:center" class ="text-success"><b>예매완료</b>';
                                        } elseif ($row['state_cd'] == 30) {
                                            $state_cd = '<td style="text-align:center" class ="text-primary"><b>상영완료</b>';
                                        } else {
                                            $state_cd = "기타";
                                        }
                                        ...
                                        echo "
                                        <tr>
                                        <td onclick=location.href='member_detail.php?member_id=" . $row['user_email'] . "&comp_cd=" . $row['comp_cd'] . "'>" . $row['user_email'] . "</td>
                                        " . $comp_cd . "
                                        <td style=\"text-align:center\">" . $row['exhbt_cd'] . "</td>
